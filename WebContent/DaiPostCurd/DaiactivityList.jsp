    	...
    	<div class = "">
  			<div class = "panel panel-default">
      			...
      			<table align="center" class="table table-bordered">
        			...
        			<tbody>
        			<c:forEach items="${daiactivity}" var="c" varStatus="st">
        				<tr>
        					<td>${c.dpost_id}</td>
              		...
              		<!-- deleteBookPost与BookPostController中注解的名字一致 -->
               				<a role="button" class="btn btn=danger btn-xs" href='deleteDaiactivity?dpost_id=${c.dpost_id}'>
